...
public class ObjectRenderer {
    ...
    private Queue<AFrameTask> mFrameTaskQueue;
    ...
    protected int mCurrentViewportWidth, mCurrentViewportHeight;
    ...
    /*public ObjectRenderer(ObjectsModel model) {
    ...
    //protected Scene getNewDefaultScene(){return new Scene();}
